    ...
    def run(self):
        ...
        for iter_num, speech_row_data in enumerate(speech_csv.iterrows()):
            ...
            for spk_num, spk_info in enumerate(speech_info.iterrows()):
                ...
                #     print(key)
                #     print(speaker_dict[key])
                current_save_dict['spk_list'].append(speaker_dict)
                # exit()
            
                # speech_row_data=speech_row_data[1] 
                # speech_len=speech_row_data['length']           
                # current_save_dict['noise']['speech_wav']=speech_row_data['audio_directory']
