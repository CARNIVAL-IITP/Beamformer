...
class acoustic_simulator_on_the_fly(simulator_common):
    ...
    def get_source_pos(self, theta, azi_pos, linear_azi_pos, mic_center, room_sz):
        ...
        return speech_pos, azi_deg, np.rad2deg(ele)
    ...
    def create_param(self, num_spk, with_coherent_noise, mic_type, mic_num):
        ...
        for i in range(num_spk):
            speech_pos, azi, ele=self.get_source_pos(theta, azi_pos, linear_azi_pos, mic_center, room_sz)
        ...
        return self.params, mic_pos, azi_pos, linear_azi_pos, ele_pos
    ...
    def create_rir(self,num_spk=1, with_coherent_noise=True, mic_type='whole', mic_num=8): 
        ...
        self.params, mic_pos, azi_list, linear_azi_pos_list, ele_list=self.create_param(num_spk, with_coherent_noise, mic_type, mic_num)
        ...
        return rirs, mic_pos, azi_list, linear_azi_pos_list, ele_list
