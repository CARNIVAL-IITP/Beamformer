...
class testset_maker_loader(datamake):
    ...
    def make_test_set(self, idx):
        ...
        for room in self.room_config_yaml:
            ...
            save_dict['target_wav']=torch.from_numpy(target_wav)
...
class val_set_maker_loader(datamake):
    ...
    def make_test_set(self, idx):
        ...
        rirs, mic_pos, azi_list, linear_azi_list, _ = self.rir_maker.create_rir(num_spk=num_spk, with_coherent_noise=with_coherent_noise, mic_type=self.args['mic_type'], mic_num=self.args['mic_num'])
