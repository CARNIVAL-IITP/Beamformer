...
class datamake():
    ...
    def make_noisy(self,duration,  rired_speech_list,  white_noise_snr, normalize_factor, speech_start_point_list,  with_coherent_noise, coherent_noise_snr, rired_noise_wav):
        ...
        clean_wav=noisy_wav[0]
        noisy_wav=noisy_wav+noise
        scaler=self.scaling(noisy_wav, normalize_factor)
        noisy_wav*=scaler
        clean_wav*=scaler
...
class train_data_loader(datamake):
    ...
    def get_speech_start_point(self, speech_wav, rir_peak, pos, clean_len):
        ...
        if pos=='full':
            ...
            back_cut=rired_len-clean_len-rir_peak
        ...
        return start_point, speech_wav


    def speech_get_wav(self, wav_file):
        ...
        return speech_wav, pos, start_point
    ...
    def main_speech_load(self, speech_info):
        ...
        return self.speech_get_wav(wav_file)
    ...
    def  __getitem__(self, idx):            
                    ...
                    for spk_num, spk_info in enumerate(speech_info.iterrows()):
                        ...
                        speech_wav, pos, speech_start_point=self.main_speech_load(spk_info)
                        s_clean=speech_wav
                        ...
                        start_point, rired_speech=self.get_speech_start_point(rired_speech, self.speech_rir_peak, pos, s_clean.shape[-1])
                    ...
                    clean, mixed=self.make_noisy(self.duration, rired_speech_list, white_noise_snr, normalize_factor, speech_start_point_list, with_coherent_noise, coherent_noise_snr, rired_noise_wav)
                    
                    mixed=self.clipping(mixed)
                    clean=self.clipping(clean)
                    ...
                    return torch.from_numpy(mixed), clean
...
class IITP_test_loader(datamake):
    ...
    def  __getitem__(self, idx):
        ...
        data_dir=self.pkl_dir+str(self.room_type)+'/'+data_row['data']
        ...
        return mixed, clean, data_dict['SNR']
